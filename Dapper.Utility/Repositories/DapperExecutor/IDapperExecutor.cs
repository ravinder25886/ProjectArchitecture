...
public interface IDapperExecutor
{
    ...
    public Task<int> ExecuteAsync(string dbName, string sql, object? param = null, CommandType commandType = CommandType.StoredProcedure);
    /// <summary>
    ...
    public Task<T?> ExecuteScalarAsync<T>(string dbName, string sql, object? param = null, CommandType commandType = CommandType.StoredProcedure);
    /// <summary>
    ...
    public Task<T?> QueryFirstOrDefaultAsync<T>(string dbName, string sql, object? param = null, CommandType commandType = CommandType.StoredProcedure);
    /// <summary>
    ...
    public Task<IEnumerable<T>> QueryAsync<T>(string dbName, string sql, object? param = null, CommandType commandType = CommandType.StoredProcedure);
    /// <summary>
    ...
    /// </returns>
    public Task<SqlMapper.GridReader> QueryMultipleAsync(string dbName, string sql, object? param = null, CommandType commandType = CommandType.StoredProcedure);
}
