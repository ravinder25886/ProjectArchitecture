...
public interface IDapperExecutor
{
   ...
   public Task<int> ExecuteAsync(string dbNameKey,string sql, object? param = null, CommandType commandType = CommandType.StoredProcedure);
    /// <summary>
    ...
    public Task<T?> ExecuteScalarAsync<T>(string dbNameKey, string sql, object? param = null, CommandType commandType = CommandType.StoredProcedure);
    /// <summary>
    ...
    public Task<T?> QueryFirstOrDefaultAsync<T>(string dbNameKey, string sql, object? param = null, CommandType commandType = CommandType.StoredProcedure);
    /// <summary>
    ...
    public Task<IEnumerable<T>> QueryAsync<T>(string dbNameKey, string sql, object? param = null, CommandType commandType = CommandType.StoredProcedure);
    /// <summary>
    ...
    /// </returns>
    public Task<SqlMapper.GridReader> QueryMultipleAsync(string dbNameKey, string sql, object? param = null, CommandType commandType = CommandType.StoredProcedure);
}
